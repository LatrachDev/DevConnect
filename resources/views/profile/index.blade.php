                    ...
                    <div class="p-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 text-sm">Full-Stack Developer at CodeWorks</p>
                        ...
                        <div class="mt-4">
                            <p class="text-gray-700">
                                Just built a new authentication system using Laravel and Vue.js! It includes JWT authentication, role-based access control, and seamless frontend integration.
                                Here's a snippet of the backend token validation logic:
                            </p>
            ...
            try {
                ...
                return response()->json(['error' => 'Unauthorized'], 401);
                            ...
                            <div class="mt-4 flex flex-wrap gap-2">
                                <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">#laravel</span>
                                <span class="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs">#vuejs</span>
                                <span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">#authentication</span>
                            </div>
